...
<nav>
    <div class="main-wrapper">
        <div class="flex-container">
            <a class="logotipo" href="{{route('index')}}">
                <img src="{{asset('images/Asset 1.svg')}}">
            </a>
            <ul class="navigation__itens" id="menu">
                <li>
                    <a href="{{route('index')}}">Página principal
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
                    <a href="{{route('produtos')}}">Produtos
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{route('sobre')}}">Sobre
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
                    <a href="{{route('contato')}}">Contato
                        <span class="border-effect"></span>
                    </a>
                </li>
            </ul>
...
<div id="resize">
    <ul id="menu">
        <li><a class="title-medium" href="{{route('index')}}">Página principal</a></li>
        <li><a class="title-medium" href="{{route('produtos')}}">Produtos</a></li>
        <li><a class="title-medium" href="{{route('blog')}}">Blog</a></li>
        <li><a class="title-medium" href="{{route('sobre')}}">Sobre</a></li>
        <li><a class="title-medium" href="{{route('contato')}}">Contato</a></li>
    </ul>
</div>
